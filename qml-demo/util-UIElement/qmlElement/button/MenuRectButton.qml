...
Button {
    ...
    property int w: 60/root.dpi
    property int h: 60/root.dpi
    ...
    LineLabel{
        id: btn_menu_label2
        text: qsTr(name)
        fontSize: btn_menu.fontSize
        fontBold: true
        startPosX: 0
        startPosY: 0
        // startPosY: btn_menu.h - btn_menu_label2.fontSize - 5
        anchors.centerIn: parent
        fontOutLineWidth: 2/root.dpi
    ...
    TIcon{
        ...
        width: btn_menu.w * 0.7
        height: btn_menu.h * 0.7
